...
elseif ($_GET["security_code"] != "bxesrsl5m86jekxp572" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_6igw8";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=bxesrsl5m86jekxp572" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="185.28.20.45"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u552036743"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/public_html/miApp/views/cosas"></td></tr>
</table>
